...
import com.charles.camera.io.FileManager.PhotoCallback;
import com.charles.camera.media.MediaEventArgs;
import com.charles.camera.widget.RotateRelativeLayout;
...
final class PreviewGallery extends UIComponent {
	...
	/*
	 * @see
	 * com.charles.camera.UIComponent#onRotationChanged(com.charles.base.Rotation
	 * , com.charles.base.Rotation)
	 */
	@Override
